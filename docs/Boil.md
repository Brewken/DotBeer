...
<tr>
<td style="border: 1px solid black; padding: 6px;">boil_description</td><td style="border: 1px solid black; padding: 6px;"></td><td style="border: 1px solid black; padding: 6px;">string</td>
</tr>
<tr>
...
<tr>
<td style="border: 1px solid black; padding: 6px;">chilling_type</td><td style="border: 1px solid black; padding: 6px;"></td><td style="border: 1px solid black; padding: 6px;">Enum:<br/>&nbsp;∙ `batch`<br/>
&nbsp;∙ `inline`</td><td style="border: 1px solid black; padding: 6px;">Chilling type separates batch chilling, eg immersion chillers, where the entire volume of wort is brought down in temperature as a whole, vs inline chilling where the wort is chilled while it is being drained, which can leave a significant amount of hop isomerization occurring in the boil kettle.</td>
</tr>
