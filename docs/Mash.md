...
<tr>
<td style="border: 1px solid black; padding: 6px;">step_type</td><td style="border: 1px solid black; padding: 6px;">✅</td><td style="border: 1px solid black; padding: 6px;">Enum:<br/>&nbsp;∙ `infusion`<br/>
&nbsp;∙ `temperature`<br/>
&nbsp;∙ `decoction`<br/>
&nbsp;∙ `souring mash`<br/>
&nbsp;∙ `souring wort`<br/>
